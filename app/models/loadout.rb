class Loadout < ActiveRecord::Base
  ...
  attr_accessible :profile_id, :profile, :name, :class_type, :general, :general_id, :weapon, :weapon_id,
    ...
    :armor_piercing, :armor_resistance, :helmet_piercing, :helmet_resistance, :shield_piercing, :shield_resistance, :glove_piercing, :glove_resistance, :boot_piercing, :boot_resistance, :power_piercing, :power_resistance, :banner, :banner_id, :attack_rune_on_banner, :banner_piercing, :banner_resistance, :amulet_piercing, :amulet_resistance
  ...
  validates :weapon_piercing, :weapon_resistance, :armor_piercing, :armor_resistance, :helmet_piercing, 
    ...
    :banner_resistance, :amulet_piercing, :amulet_resistance, :numericality => { :only_integer => true }
